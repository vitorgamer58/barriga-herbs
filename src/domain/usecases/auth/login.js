const { usecase, step, Ok, Err, ifElse, request } = require('@herbsjs/herbs');
...
module.exports = herbarium.usecases.add(login, 'Login').metadata({
  group: 'Auth',
  entity: loginRequest,
  operation: herbarium.crud.other,
  REST: { post: '/auth/signin' }
}).usecase;
