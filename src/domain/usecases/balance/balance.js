const { usecase, step, Ok, Err, entity } = require('@herbsjs/herbs');
...
const getBalance = (injection) =>
  usecase('Get the user balance', {
    request: {},
...
module.exports = herbarium.usecases.add(getBalance, 'Get the user balance').metadata({
  group: 'Balance',
