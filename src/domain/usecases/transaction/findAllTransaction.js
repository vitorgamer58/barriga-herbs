...
const findAllTransaction = (injection) =>
  usecase('Find all Transactions', {
    request: {
      limit: Number,
      offset: Number
    },
...
module.exports = herbarium.usecases.add(findAllTransaction, 'FindAllTransaction').metadata({
  group: 'Transaction',
